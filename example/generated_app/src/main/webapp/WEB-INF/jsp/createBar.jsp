...
<html>
    <head>
        ...
        <title>Form for bar</title>
    </head>
    <body>
        <%@ include file="navbar.jsp"%>
        <div class="container">
            <form:form method="POST" modelAttribute="bar" action="/bars" >
                <form:hidden path="id" />
                    ...
                    <div class="form-group">
                        <label for="pff">Pff</label>
                        <form:input type="text" class="form-control" id="pff" path="pff" />
                    </div>
